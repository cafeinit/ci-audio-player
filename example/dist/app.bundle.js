...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(() => {
  ...
  function render() {
    renderPlayList(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#play-list'), myPlayList.getItems())
    renderPlayer(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#player'), {
...
function renderPlayList($el, data) {
  ...
  data.map((item, i) => {
    ...
    let $item = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`<li class="${className}">
      <div class="track">
        <em class="no">${i}</em>
